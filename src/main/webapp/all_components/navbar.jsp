...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		if (user != null) {
		%>
		<a class="btn btn-light my-2 my-sm-0 mr-3" data-toggle="modal" data-target="#exampleModal" type="submit"
			href=""><i class="fa fa-user-circle-o"
			aria-hidden="true"></i> <%= user.getName() %></a> 
			
			
			<a class="btn btn-light my-2 my-sm-0"
			type="submit" href="LogoutServlet"><i class="fa fa-user-plus"
      ...
      <div class="modal-body">
       ...
       <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
		...
		<a class="btn btn-light my-2 my-sm-0 mr-3" type="submit"
			...
			<a class="btn btn-light my-2 my-sm-0"
			type="submit" href="register.jsp"><i class="fa fa-user-plus"
